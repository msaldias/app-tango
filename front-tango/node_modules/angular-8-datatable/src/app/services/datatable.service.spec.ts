...
import { DataTableService, PageEvent, SortEvent } from "./datatable.service";
...
describe("DataTable directive tests", () => {
    ...
    beforeEach(() => {
        ...
        datatable = fixture.debugElement.query(By.directive(DataTableService)).injector.get(DataTableService) as DataTableService;
