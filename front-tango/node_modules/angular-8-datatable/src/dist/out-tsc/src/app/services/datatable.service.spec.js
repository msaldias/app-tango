...
describe("DataTable directive tests", () => {
    ...
    beforeEach(() => {
        TestBed.configureTestingModule({
            declarations: [DataTableService, TestComponent]
        });
        fixture = TestBed.createComponent(TestComponent);
        datatable = fixture.debugElement.query(By.directive(DataTableService)).injector.get(DataTableService);
        datatable.inputData = [
            { id: 3, name: 'moise' },
            { id: 1, name: 'Duck' },
            { id: 2, name: 'ącki' },
    ...
    describe("initializing", () => {
        ...
        it("data should be 2 first items", () => {
            ...
            datatable.ngDoCheck();
            expect(datatable.data).toEqual([{ id: 3, name: 'moise' }, { id: 1, name: 'Duck' }]);
        });
        it("data should be 3. and 4. items", () => {
            datatable.rowsOnPage = 2;
            datatable.activePage = 2;
            datatable.ngDoCheck();
            expect(datatable.data).toEqual([{ id: 2, name: 'ącki' }, { id: 5, name: 'Ciprien' }]);
        });
    ...
    describe("pagination", () => {
        ...
        it("data should be three first items when page change", () => {
            ...
            datatable.ngDoCheck();
            expect(datatable.data).toEqual([{ id: 3, name: 'moise' }, { id: 1, name: 'Duck' }, { id: 2, name: 'ącki' }]);
        });
        it("data should be two last items when page change", () => {
            datatable.setPage(2, 3);
            datatable.setPage(2, 3);
            datatable.ngDoCheck();
            expect(datatable.data).toEqual([{ id: 5, name: 'Ciprien' }, { id: 4, name: 'Ananas' }]);
        });
        it("should change rowsOnPage when mfRowsOnPage changed", (done) => {
            datatable.rowsOnPage = 2;
            datatable.ngDoCheck();
            expect(datatable.data).toEqual([{ id: 3, name: 'moise' }, { id: 1, name: 'Duck' }]);
            datatable.onPageChange.subscribe((pageOptions) => {
    ...
    describe("sorting", () => {
        ...
        it("should fire onSortChange event after sorting input value changed", (done) => {
            datatable.onSortChange.subscribe((event) => {
        ...
        it("should call output event when sorting changed", (done) => {
            datatable.ngDoCheck();
            datatable.sortByChange.pipe(switchMap((sortBy) => {
    ...
    describe("data change", () => {
        it("should refresh data when inputData change", () => {
            let newData = [{ id: 5, name: 'Ciprien' }, { id: 4, name: 'Ananas' }];
            datatable.ngOnChanges({ inputData: new SimpleChange(datatable.inputData, newData, false) });
            datatable.ngDoCheck();
            expect(datatable.data).toEqual([{ id: 5, name: 'Ciprien' }, { id: 4, name: 'Ananas' }]);
        });
        ...
        it("should fire onPageChange event after inputData change", (done) => {
            datatable.setPage(2, 2);
            datatable.ngDoCheck();
            datatable.onPageChange.subscribe((opt) => {
        ...
        it("shouldn't change page when can display data after data changed", () => {
            ...
            datatable.ngDoCheck();
            let newData = [{ id: 5, name: 'Ciprien' }, { id: 1, name: 'Duck' }, { id: 4, name: 'Ananas' }];
            datatable.ngOnChanges({ inputData: new SimpleChange(datatable.inputData, newData, false) });
            datatable.ngDoCheck();
...
//# sourceMappingURL=datatable.service.spec.js.map